...
The documentation site works without the live backend by showing recorded receipts from the verified Phase 2 run. `npm run demo:ui` additionally exposes the local demo bridge so the playground can generate fresh proofs.
