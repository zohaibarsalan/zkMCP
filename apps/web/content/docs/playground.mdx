---
title: Playground
description: Inspect the final verified authorization scenarios, compare private inputs with public receipts, or generate fresh local Midnight proofs.
full: true
toc: false
---
...
The receipt values shown in recorded mode are not invented UI fixtures. They came from the final verified MCP + Midnight transactions documented under [Verification evidence](/docs/development/verification).
